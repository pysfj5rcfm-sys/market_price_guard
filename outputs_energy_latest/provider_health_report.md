...
- attempts:
  ...
  - provider=yfinance, function_name=yfinance.Ticker, status=success, price=26.760000228881836, quote_time=2026-05-18T16:08:00+08:00, usable_for_operation=True, elapsed_seconds=2.703, slow_provider_attempt=False, reason=, exception_type=, exception_message=
### 601899.SH
- provider_priority_chain: akshare, yfinance, mock
- selected_provider: yfinance
- selected_source: yfinance
...
- final_blocking_reason: 
- attempts:
  - provider=akshare, function_name=stock_zh_a_spot_em, status=failed, price=, quote_time=, usable_for_operation=False, elapsed_seconds=15.318, slow_provider_attempt=True, reason=provider_timeout, exception_type=ConnectionError, exception_message=('Connection aborted.', RemoteDisconnected('Remote end closed connection without response'))
  - provider=akshare, function_name=stock_sh_a_spot_em, status=failed, price=, quote_time=, usable_for_operation=False, elapsed_seconds=15.318, slow_provider_attempt=True, reason=provider_timeout, exception_type=ConnectionError, exception_message=('Connection aborted.', RemoteDisconnected('Remote end closed connection without response'))
  - provider=yfinance, function_name=yfinance.Ticker, status=success, price=31.299999237060547, quote_time=2026-05-18T14:57:00+08:00, usable_for_operation=True, elapsed_seconds=0.763, slow_provider_attempt=False, reason=, exception_type=, exception_message=
### 601985.SH
- provider_priority_chain: akshare, yfinance, mock
- selected_provider: yfinance
- selected_source: yfinance
...
- final_blocking_reason: 
- attempts:
  - provider=akshare, function_name=stock_zh_a_spot_em, status=failed, price=, quote_time=, usable_for_operation=False, elapsed_seconds=15.62, slow_provider_attempt=True, reason=provider_timeout, exception_type=ConnectionError, exception_message=('Connection aborted.', RemoteDisconnected('Remote end closed connection without response'))
  - provider=akshare, function_name=stock_sh_a_spot_em, status=failed, price=, quote_time=, usable_for_operation=False, elapsed_seconds=15.62, slow_provider_attempt=True, reason=provider_timeout, exception_type=ConnectionError, exception_message=('Connection aborted.', RemoteDisconnected('Remote end closed connection without response'))
  - provider=yfinance, function_name=yfinance.Ticker, status=success, price=9.050000190734863, quote_time=2026-05-18T14:56:00+08:00, usable_for_operation=True, elapsed_seconds=0.758, slow_provider_attempt=False, reason=, exception_type=, exception_message=
### 003816.SZ
- provider_priority_chain: akshare, yfinance, mock
- selected_provider: yfinance
- selected_source: yfinance
...
- final_blocking_reason: 
- attempts:
  - provider=akshare, function_name=stock_zh_a_spot_em, status=failed, price=, quote_time=, usable_for_operation=False, elapsed_seconds=15.421, slow_provider_attempt=True, reason=provider_timeout, exception_type=ConnectionError, exception_message=('Connection aborted.', RemoteDisconnected('Remote end closed connection without response'))
  - provider=akshare, function_name=stock_sz_a_spot_em, status=failed, price=, quote_time=, usable_for_operation=False, elapsed_seconds=15.421, slow_provider_attempt=True, reason=provider_timeout, exception_type=ConnectionError, exception_message=('Connection aborted.', RemoteDisconnected('Remote end closed connection without response'))
  - provider=yfinance, function_name=yfinance.Ticker, status=success, price=4.800000190734863, quote_time=2026-05-18T14:59:00+08:00, usable_for_operation=True, elapsed_seconds=0.692, slow_provider_attempt=False, reason=, exception_type=, exception_message=
