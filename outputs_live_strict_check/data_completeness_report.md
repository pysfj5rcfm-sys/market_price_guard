...
- project=energy, symbol=00883.HK, name=中海油H, source=akshare, quote_time=, is_stale=True, stale_reason=provider_error: 行情源调用失败，不可用于具体操作建议；provider_error, blocking_reason=provider_error
- project=energy, symbol=601899.SH, name=紫金矿业A, source=akshare, quote_time=, is_stale=True, stale_reason=provider_error: 行情源调用失败，不可用于具体操作建议；provider_error, blocking_reason=provider_error
- project=energy, symbol=601985.SH, name=中国核电, source=akshare, quote_time=, is_stale=True, stale_reason=provider_error: 行情源调用失败，不可用于具体操作建议；provider_error, blocking_reason=provider_error
- project=energy, symbol=003816.SZ, name=中国广核, source=akshare, quote_time=, is_stale=True, stale_reason=provider_error: 行情源调用失败，不可用于具体操作建议；provider_error, blocking_reason=provider_error
- project=tech, symbol=159632.SZ, name=纳斯达克ETF华安, source=akshare, quote_time=, is_stale=True, stale_reason=quote_time_missing: quote_time 缺失，无法证明价格新鲜，不可用于具体操作建议；quote_time_missing, blocking_reason=quote_time_missing
- project=tech, symbol=513300.SH, name=纳斯达克ETF华夏, source=akshare, quote_time=, is_stale=True, stale_reason=quote_time_missing: quote_time 缺失，无法证明价格新鲜，不可用于具体操作建议；quote_time_missing, blocking_reason=quote_time_missing
- project=tech, symbol=159819.SZ, name=人工智能ETF易方达, source=akshare, quote_time=, is_stale=True, stale_reason=quote_time_missing: quote_time 缺失，无法证明价格新鲜，不可用于具体操作建议；quote_time_missing, blocking_reason=quote_time_missing
- project=tech, symbol=515880.SH, name=通信ETF国泰, source=akshare, quote_time=, is_stale=True, stale_reason=quote_time_missing: quote_time 缺失，无法证明价格新鲜，不可用于具体操作建议；quote_time_missing, blocking_reason=quote_time_missing
