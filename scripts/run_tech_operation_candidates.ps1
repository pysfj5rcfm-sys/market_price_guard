...
Write-Host 'universe: tech_operation_candidates'
...
& $Python -m market_price_guard.main --profile tech --universe tech_operation_candidates --provider-mode live --quote-purpose reference --provider-policy fast --output-dir outputs_tech_operation_candidates_latest
