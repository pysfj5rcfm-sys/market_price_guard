...
Write-Host 'provider-policy: diagnostic'
Write-Host 'quote-purpose: reference'
Write-Host 'reconcile-mode: full'
Write-Host ('output-dir: ' + $OutputDir)

Push-Location $ProjectRoot
& $Python -m market_price_guard.main --profile tech --provider-mode live --provider-policy diagnostic --quote-purpose reference --reconcile-mode full --output-dir outputs_tech_reconcile_latest
