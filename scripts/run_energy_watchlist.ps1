...
Write-Host 'universe: energy_watchlist'
...
& $Python -m market_price_guard.main --profile energy --universe energy_watchlist --provider-mode live --quote-purpose reference --provider-policy fast --output-dir outputs_energy_watchlist_latest
