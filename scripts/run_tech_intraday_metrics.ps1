...
Write-Host 'output-type: reference_intraday_metrics'
Write-Host 'strict: false'
...
& $Python -m market_price_guard.intraday_metrics --output-dir outputs_tech_intraday_latest
